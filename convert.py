...
def main():
    ...
    if args.command == "extract-structure":
        extract_structure.run(pdf_path=args.pdf, output_prompt=args.output_prompt)
        ...
        convert_scene.run(scene_path=args.scene, adventure_outline_path=args.adventure_outline, notes_path=args.notes)
        ...
        summarize_adventure.run(adventure_path=args.adventure)
